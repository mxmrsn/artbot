...
#define SERVO_MIN_PULSE_WIDTH      1000     // the shortest pulse sent to a servo  
#define SERVO_MAX_PULSE_WIDTH      2000     // the longest pulse sent to a servo 
#define SERVO_DEFAULT_PULSE_WIDTH  1000     // default pulse width when servo is attached
